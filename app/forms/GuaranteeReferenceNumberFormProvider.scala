      ...
      "value" -> text("guaranteeReferenceNumber.error.required")
        .verifying(
          forms.StopOnFirstFail[String](
            maxLength(maxGuaranteeReferenceNumberLength, "guaranteeReferenceNumber.error.maxLength"),
            minLength(minGuaranteeReferenceNumberLength, "guaranteeReferenceNumber.error.minLength"),
